...
with open('/home/ris/PycharmProjects/pythonProject/USA-housing/dags/models/encoded.pickle', 'rb') as handle:
    encoded_dict = pickle.load(handle)

print('encoded dict train_data',encoded_dict)


model_path = "/home/ris/PycharmProjects/pythonProject/USA-housing/dags/models/knearest.pickle"
